...
export default function AlertDialogDeletNiño({ open, onCancel, onConfirm, id }) {
    if (!open) return null;
    ...
    const defaultDeleteUsuario = async (userId) => {
        setIsLoading(true)
        try {
            const response = await fetch(`${API_URL}ninios/${userId}`, {
                method: 'DELETE',
            });
        ...
        >
            ...
            >
                ...
                <div className="div--parrafos">
                    <h5>¿Estás seguro de que quieres eliminar este Niño?</h5>

                    <p>Si elimina este paciente (niño) ya no podrás recuperar su información.</p>
                </div>
